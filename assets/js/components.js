  ...
  <div class="footer-content">
    <div class="footer-grid">
      ...
      <div class="footer-col-brand">
        ...
        <p class="footer-tag">Fine art Wildlife, Landscape, Water photography.<br>Collector's Reserve Edition signed prints. Scottsdale, Arizona.<br>Shipped across North America<br>and Canada.</p>
        <div class="socials">
      ...
      <div>
        ...
        <ul>
          ...
          <li><a href="${r}the-shop.html?edition=collectors-reserve">Collector's Reserve Edition</a></li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul>
          ...
          <li><a href="${r}collectors-promise.html">The Collector's Promise</a></li>
        </ul>
      </div>
